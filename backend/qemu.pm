...
sub save_memory_dump ($self, $args) {
    ...
    my $migration_use_multifd = $vars->{QEMU_USE_MULTIFD_FOR_MIGRATION} // (version->declare($self->{qemu_version}) ge version->declare(9.1));
...
sub save_snapshot ($self, $args) {
    ...
    $self->_migrate_to_file(
        ...
        migration_use_multifd => (version->declare($self->{qemu_version}) ge version->declare(9.1)) || $vars->{QEMU_USE_MULTIFD_FOR_MIGRATION},
        max_bandwidth => $vars->{QEMU_MAX_BANDWIDTH});
...
sub load_snapshot ($self, $args) {
    ...
    # poo#167218: From qemu 9.1, the "compress" migration capability has been removed,
    # but multifd migration is able to do compression and can be used instead.
    my $migration_use_multifd = (version->declare($self->{qemu_version}) ge version->declare(9.1)) || $vars->{QEMU_USE_MULTIFD_FOR_MIGRATION};
    my $fdname = 'dumpfd';
