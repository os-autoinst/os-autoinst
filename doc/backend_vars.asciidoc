...
SCHEDULE;string;;comma separated list of relative paths to test modules within *CASEDIR* to be scheduled. _e.g. "SCHEDULE=boot/boot_to_desktop,console/mod1"_.
