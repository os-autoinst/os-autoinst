...
HDD_LOGICAL_BLOCK_SIZE;integer;undef;see QEMU_HDD_LOGICAL_BLOCK_SIZE
HDD_PHYSICAL_BLOCK_SIZE;integer;undef;specifies the block size and boot sector size of the HDD image
