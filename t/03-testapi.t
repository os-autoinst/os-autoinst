...
send_key 'f12', hold_duration => 2;
is_deeply $cmds, [{cmd => 'backend_send_key', key => 'f12', hold_duration => 2}], 'send_key forwards hold_duration parameter' or always_explain $cmds;
$cmds = [];
